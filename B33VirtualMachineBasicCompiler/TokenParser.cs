...
namespace B33VirtualMachineBasicCompiler
{
    internal class TokenParser
    {
        ...
        public TokenParser()
        {
            ...
            _tokens.Add(Tokens.INSTR, "[Ii][Nn][Ss][Tt][Rr][ \\t]*\\(");
            ...
            _tokens.Add(Tokens.LTRIM, "[Ll][Tt][Rr][Ii][Mm][\\$]");
            _tokens.Add(Tokens.RTRIM, "[Rr][Tt][Rr][Ii][Mm][\\$]");
            ...
            _tokens.Add(Tokens.ASC, "[Aa][Ss][Cc][ \\t]*\\(");
        ...
        internal static IEnumerable<Tokens> GetNumericFunctionsList()
        {
        ...
        internal static IEnumerable<Tokens> GetStatementsList()
        {
            return new List<Tokens>
            {
                Tokens.AND,
